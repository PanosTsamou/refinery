...
public class Bolts {
    ...
    public Bolts(Long serialNum, String brand, String name, String madeIn, String headStyle, String gradeClass, String material, String exteriorFin, Float length, String size, Boolean box, Integer boxSize, String img) {

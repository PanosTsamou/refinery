...
@Entity
@Table (name = "socket_wrench")
public class SocketWrench extends Tools{
    ...
    public SocketWrench(Long serialNum, String brand, String name, String madeIn, List<ToolBox> toolBoxes, String headStyle, String size, Boolean set) {
